    ...
    <div class="row cs">
        <div class="col-12">
            <div class="align-right">
                ...
                <a href="/admin/view/result/tester/{{$id}}"><button type="button">List Tester</button></a>
...
<script>
    function savelink(){
        ...
        var data = "http://192.168.1.71:8600/result/test_id={{$id}}/tested={{$test[0]->tested_employee}}";
